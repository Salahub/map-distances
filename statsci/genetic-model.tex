...
\begin{equation} \label{eq:crossedCorr}
  \frac{ \sigma_{jk}^2 + \delta_m \left(1 - \bar{z}_{\text{ref}}^2 \right ) - m_{12}}{\sqrt{ \widehat{\sigma}_{kk}^2 \Big [ \widehat{\sigma}_{jj}^2 - \delta_m \left ( 3 - 2 \bar{z}_{\text{ref}} + \frac{\delta_m}{n} \right )  }}. \\
\end{equation}
