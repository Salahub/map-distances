...
\begin{figure}[htp]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{The pairwise units used to construct the correlation distribution and correlation test plots. (a) and (b) display the distribution of correlations in 10,000 simulated populations of 80 individuals while (c) uses the distribution of the mean of 10,000 pairs of populations of 66 and 94.}
  \label{fig:2by2}
\end{figure}
...
\end{equation}
Noting that $\bar{z}_j^* = \bar{z}_k^* := \bar{z}_{\text{ref}}$ and $s_{jj}^* = s_{kk}^* = s_{jk}^* := s_{..}$ by construction, this can be further simplified to
