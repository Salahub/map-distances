...
A more interesting noise pattern is seen between chromosomes in the \cite{LanderBotstein1989} setting, where both negative and positive correlations are observed. While the 
