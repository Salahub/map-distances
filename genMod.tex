...
\end{equation}
be the correlation in the reference case without any cross overs. As we cannot have more cross overs under this simplification than the reference marker, we must have
$$m \leq n(\bar{z}_k^* - 1).$$
