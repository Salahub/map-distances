...
\begin{figure}[htp]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{The distribution of the correlation between markers D2Mit22 and a over 10,000 simulated BSB crosses.}
  \label{fig:discrete}
\end{figure}
...
\begin{figure}[htp]
  \begin{center}
      \includegraphics[width = 0.7\textwidth]{./img/meanSim.png}
  \end{center}
...
\begin{figure}[htp]
  \begin{center}
      \includegraphics[width = 0.7\textwidth]{./img/meanSimBig.png}
  \end{center}
