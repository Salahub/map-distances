...
\begin{abstract}
  A structural model of the genome is devised. Under common assumptions, a first-principles derivation of the Haldane map distance and genetic correlation is completed under this model. The results of the model are compared to real data resulting from the BSB mouse cross. Correlation test plots are motivated and used to facilitate this comparison, which indicates a close agreement of the model and reality.
\end{abstract}
...
In the lower cells, the lack of shading suggests close agreement of the model to reality. Only two of the comparisons have means in a rejection region, almost all of the others are 
