...
Nonetheless, \cite{LiJi2005} investigate 10 ``independent regions'' within each of which 5 markers are placed such that adjacent markers have an $r^2$ of 0.8 between them. This design is analogous to that of \cite{LanderBotstein1989}, despite the difference in language and description.
